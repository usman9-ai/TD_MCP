...
def docstring_handler(
    ...
    PARAMETERS:
        ...
        include_params:
            Optional Argument.
            List of parameter keys to include from common_params. If not specified, all parameters from common_params are included.
            Types: list of str
    ...
    EXAMPLES:
        ...
        def my_func(...):
            ...
    """
    included_keys = set(include_params) if include_params else None
    ...
    def decorator(method: Callable) -> Callable:
        ...
        if common_params:
            ...
            for param_key, spec in common_params.items():
                # Apply include_params filter first (if specified)
                if included_keys is not None and param_key not in included_keys:
                    continue
